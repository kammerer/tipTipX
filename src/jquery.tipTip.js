...
(function($){
  function TipTip(elements, options) {
	 	this.opts = $.extend({}, TipTip.defaults, options);
  ...
  TipTip.prototype.position_at_top = function(preserve_left_right) {
  ...
  TipTip.prototype.position_at_bottom = function(preserve_left_right) {
    if (preserve_left_right)
  ...
  TipTip.prototype.position_at_left = function() {
    this.t_class = "_left";
  ...
  TipTip.prototype.position_at_right = function() {
    this.t_class = "_right";
    this.arrow_top = Math.round(this.tip_h - 13) / 2;
    this.arrow_left = -12;
  ...
  TipTip.prototype.position_at_left_top = function() {
    this.position_at_left();
    this.position_at_top(true);
  };

  TipTip.prototype.position_at_right_top = function() {
    this.position_at_right();
    this.position_at_top(true);
  };

  TipTip.prototype.position_at_left_bottom = function() {
    this.position_at_left();
    this.position_at_bottom(true);
  };

  TipTip.prototype.position_at_right_bottom = function() {
    this.position_at_right();
    this.position_at_bottom(true);
  };
  ...
  $.fn.tipTipDefaults = function(options) {
    $.extend(TipTip.defaults, options);
  };
